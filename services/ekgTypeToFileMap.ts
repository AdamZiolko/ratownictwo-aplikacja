...
export const ekgTypeToFilename: Record<EkgType, string> = {
  ...
  [EkgType.PREMATURE_VENTRICULAR_CONTRACTION]: 'przedwczesne-pobudzenie-komorewe',
  [EkgType.PREMATURE_ATRIAL_CONTRACTION]: 'przedwczesne-pobudzenie-przedsionkowe',
  ...
  [EkgType.MULTIFOCAL_ATRIAL_TACHYCARDIA]: 'wieloogniskowy-czestoskurcz-przedsionkowy',
