  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (roles.includes('ROLE_ADMIN')) {
        ...
        setLoginError(
          'Twoje konto oczekuje na nadanie uprawnień. Skontaktuj się z administratorem.   :('
        );
        setSnackbarMessage(
          'Konto wymaga nadania uprawnień przez administratora'
        );
      ...
      <View style={isLandscape ? styles.landscapeInputsRow : undefined}>
        ...
        >
          ...
          {regPassword && (
            ...
            >
              Hasło musi mieć min. 8 znaków: małą literę, wielką literę, cyfrę i
              znak specjalny (@$!%*?&)
            </HelperText>
          )}
        </View>
